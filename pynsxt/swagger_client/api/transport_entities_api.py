...
class TransportEntitiesApi(object):
    ...
    def get_tunnel(self, node_id, tunnel_name, **kwargs):  # noqa: E501
        ...
        >>> thread = api.get_tunnel(node_id, tunnel_name, async=True)
        >>> result = thread.get()
    ...
    def get_tunnel_with_http_info(self, node_id, tunnel_name, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_tunnel_with_http_info(node_id, tunnel_name, async=True)
        >>> result = thread.get()
    ...
    def query_tunnels(self, node_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.query_tunnels(node_id, async=True)
        >>> result = thread.get()
    ...
    def query_tunnels_with_http_info(self, node_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.query_tunnels_with_http_info(node_id, async=True)
        >>> result = thread.get()
        ...
        if 'page_size' in params and params['page_size'] > 1000:  # noqa: E501
            raise ValueError("Invalid value for parameter `page_size` when calling `query_tunnels`, must be a value less than or equal to `1000`")  # noqa: E501
        if 'page_size' in params and params['page_size'] < 0:  # noqa: E501
            raise ValueError("Invalid value for parameter `page_size` when calling `query_tunnels`, must be a value greater than or equal to `0`")  # noqa: E501
        collection_formats = {}
