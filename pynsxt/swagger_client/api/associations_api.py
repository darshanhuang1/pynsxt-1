...
class AssociationsApi(object):
    ...
    def get_associations(self, associated_resource_type, resource_id, resource_type, **kwargs):  # noqa: E501
        ...
        >>> thread = api.get_associations(associated_resource_type, resource_id, resource_type, async=True)
        >>> result = thread.get()
    ...
    def get_associations_with_http_info(self, associated_resource_type, resource_id, resource_type, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_associations_with_http_info(associated_resource_type, resource_id, resource_type, async=True)
        >>> result = thread.get()
        ...
        if 'page_size' in params and params['page_size'] > 1000:  # noqa: E501
            raise ValueError("Invalid value for parameter `page_size` when calling `get_associations`, must be a value less than or equal to `1000`")  # noqa: E501
        if 'page_size' in params and params['page_size'] < 0:  # noqa: E501
            raise ValueError("Invalid value for parameter `page_size` when calling `get_associations`, must be a value greater than or equal to `0`")  # noqa: E501
        collection_formats = {}
