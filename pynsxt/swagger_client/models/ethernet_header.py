...
class EthernetHeader(object):
    ...
    def eth_type(self, eth_type):
        ...
        :type: int
        """
        if eth_type is not None and eth_type > 65535:  # noqa: E501
            raise ValueError("Invalid value for `eth_type`, must be a value less than or equal to `65535`")  # noqa: E501
        if eth_type is not None and eth_type < 1:  # noqa: E501
            raise ValueError("Invalid value for `eth_type`, must be a value greater than or equal to `1`")  # noqa: E501
