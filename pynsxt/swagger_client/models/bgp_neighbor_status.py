...
class BgpNeighborStatus(object):
    ...
    def __init__(self, transport_node=None, connection_state=None, neighbor_address=None, messages_sent=None, connection_drop_count=None, remote_port=None, source_address=None, total_in_prefix_count=None, messages_received=None, neighbor_router_id=None, total_out_prefix_count=None, lr_component_id=None, graceful_restart=None, remote_as_number=None, announced_capabilities=None, local_port=None, keep_alive_interval=None, time_since_established=None, hold_time=None, negotiated_capability=None, established_connection_count=None):  # noqa: E501
    ...
    def transport_node(self):
        ...
        Transport node id and name  # noqa: E501
    ...
    def connection_state(self, connection_state):
        ...
        :type: str
        """
        allowed_values = ["INVALID", "IDLE", "CONNECT", "ACTIVE", "OPEN_SENT", "OPEN_CONFIRM", "ESTABLISHED"]  # noqa: E501
    ...
    def remote_port(self, remote_port):
        ...
        :type: int
        """
        if remote_port is not None and remote_port > 65535:  # noqa: E501
            raise ValueError("Invalid value for `remote_port`, must be a value less than or equal to `65535`")  # noqa: E501
        if remote_port is not None and remote_port < 1:  # noqa: E501
            raise ValueError("Invalid value for `remote_port`, must be a value greater than or equal to `1`")  # noqa: E501
    ...
    def graceful_restart(self):
        ...
        Indicate current state of graceful restart where graceful_restart = true indicate graceful restart is enabled and graceful_restart = false indicate graceful restart is disabled.  # noqa: E501
    ...
    def local_port(self, local_port):
        ...
        :type: int
        """
        if local_port is not None and local_port > 65535:  # noqa: E501
            raise ValueError("Invalid value for `local_port`, must be a value less than or equal to `65535`")  # noqa: E501
        if local_port is not None and local_port < 1:  # noqa: E501
            raise ValueError("Invalid value for `local_port`, must be a value greater than or equal to `1`")  # noqa: E501
    ...
    def time_since_established(self):
        ...
        Time(in milliseconds) since connection was established.  # noqa: E501
