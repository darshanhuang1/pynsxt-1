...
class RegistrationToken(object):
    ...
    def __init__(self, token=None, roles=None):  # noqa: E501
    ...
    @property
    def roles(self):
        """Gets the roles of this RegistrationToken.  # noqa: E501

        List results  # noqa: E501

        :return: The roles of this RegistrationToken.  # noqa: E501
        :rtype: list[str]
        """
        return self._roles
    ...
    def roles(self, roles):
        """Sets the roles of this RegistrationToken.

        List results  # noqa: E501

        :param roles: The roles of this RegistrationToken.  # noqa: E501
        :type: list[str]
        """
        if roles is None:
