...
from swagger_client.models.security_certificate import SecurityCertificate  # noqa: F401,E501
...
class CertificateKeyPair(object):
    ...
    def rsa_private_key(self):
        ...
        The private key must include the enclosing BEGIN and END blocks. An empty string is returned in read responses.  # noqa: E501
    ...
    def rsa_private_key(self, rsa_private_key):
        ...
        if rsa_private_key is not None and len(rsa_private_key) < 60:
            raise ValueError("Invalid value for `rsa_private_key`, length must be greater than or equal to `60`")  # noqa: E501
