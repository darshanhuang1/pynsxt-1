...
class TraceflowObservationDelivered(object):
    ...
    def __init__(self, resource_type='TraceflowObservationReceived', component_type=None, transport_node_id=None, timestamp=None, transport_node_name=None, sequence_no=None, timestamp_micro=None, component_name=None, lport_name=None, vlan_id=None, lport_id=None):  # noqa: E501
