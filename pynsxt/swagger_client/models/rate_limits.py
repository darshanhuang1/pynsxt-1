...
class RateLimits(object):
    ...
    def rx_multicast(self, rx_multicast):
        ...
        :type: int
        """
        if rx_multicast is not None and rx_multicast < 0:  # noqa: E501
            raise ValueError("Invalid value for `rx_multicast`, must be a value greater than or equal to `0`")  # noqa: E501
    ...
    def tx_multicast(self, tx_multicast):
        ...
        :type: int
        """
        if tx_multicast is not None and tx_multicast < 0:  # noqa: E501
            raise ValueError("Invalid value for `tx_multicast`, must be a value greater than or equal to `0`")  # noqa: E501
    ...
    def tx_broadcast(self, tx_broadcast):
        ...
        :type: int
        """
        if tx_broadcast is not None and tx_broadcast < 0:  # noqa: E501
            raise ValueError("Invalid value for `tx_broadcast`, must be a value greater than or equal to `0`")  # noqa: E501
    ...
    def rx_broadcast(self, rx_broadcast):
        ...
        :type: int
        """
        if rx_broadcast is not None and rx_broadcast < 0:  # noqa: E501
            raise ValueError("Invalid value for `rx_broadcast`, must be a value greater than or equal to `0`")  # noqa: E501
