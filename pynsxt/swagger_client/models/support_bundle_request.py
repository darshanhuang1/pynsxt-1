...
from swagger_client.models.support_bundle_remote_file_server import SupportBundleRemoteFileServer  # noqa: F401,E501
...
class SupportBundleRequest(object):
    ...
    def remote_file_server(self):
        ...
        Remote file server to copy bundles to, bundle in response body if not specified  # noqa: E501
    ...
    def log_age_limit(self, log_age_limit):
        ...
        :type: int
        """
        if log_age_limit is not None and log_age_limit < 1:  # noqa: E501
            raise ValueError("Invalid value for `log_age_limit`, must be a value greater than or equal to `1`")  # noqa: E501
