...
class ConfigurationStateElement(object):
    ...
    def __init__(self, sub_system_address=None, state=None, sub_system_type=None, failure_message=None, failure_code=None, sub_system_id=None):  # noqa: E501
    ...
    def state(self, state):
        ...
        :type: str
        """
        allowed_values = ["in_progress", "success", "failed", "partial_success"]  # noqa: E501
