...
class SecurityCertificate(object):
    ...
    def text(self, text):
        ...
        :type: str
        """
        if text is not None and len(text) < 52:
            raise ValueError("Invalid value for `text`, length must be greater than or equal to `52`")  # noqa: E501
    ...
    def pem_encoded(self, pem_encoded):
        ...
        if pem_encoded is not None and len(pem_encoded) < 52:
            raise ValueError("Invalid value for `pem_encoded`, length must be greater than or equal to `52`")  # noqa: E501
