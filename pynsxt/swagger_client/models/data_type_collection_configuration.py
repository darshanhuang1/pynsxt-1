...
class DataTypeCollectionConfiguration(object):
    ...
    def collection_frequency(self, collection_frequency):
        ...
        if collection_frequency is not None and collection_frequency > 86400:  # noqa: E501
            raise ValueError("Invalid value for `collection_frequency`, must be a value less than or equal to `86400`")  # noqa: E501
        if collection_frequency is not None and collection_frequency < 1:  # noqa: E501
            raise ValueError("Invalid value for `collection_frequency`, must be a value greater than or equal to `1`")  # noqa: E501
