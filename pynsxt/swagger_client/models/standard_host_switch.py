...
from swagger_client.models.cpu_core_config_for_enhanced_networking_stack_switch import CpuCoreConfigForEnhancedNetworkingStackSwitch  # noqa: F401,E501
from swagger_client.models.host_switch_profile_type_id_entry import HostSwitchProfileTypeIdEntry  # noqa: F401,E501
from swagger_client.models.ip_assignment_spec import IpAssignmentSpec  # noqa: F401,E501
from swagger_client.models.pnic import Pnic  # noqa: F401,E501
...
class StandardHostSwitch(object):
    ...
    def __init__(self, pnics=None, host_switch_name='nsxDefaultHostSwitch', ip_assignment_spec=None, cpu_config=None, host_switch_profile_ids=None):  # noqa: E501
    ...
    def ip_assignment_spec(self):
        ...
        IPs can come from either a static IP pool or an explicitly specified IP list or DHCP. In case a list of IP is specified, the number of IPs provided should be sufficient as per teaming policy associated with host switch uplink profile.  # noqa: E501
    ...
    def cpu_config(self):
        ...
        CPU configuration specifies number of Logical cpu cores (Lcores) per Non Uniform Memory Access (NUMA) node dedicated to Enhnaced Networking Stack enabled HostSwitch to get the best performance.  # noqa: E501
