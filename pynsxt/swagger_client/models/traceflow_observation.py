...
class TraceflowObservation(object):
    ...
    def __init__(self, resource_type='TraceflowObservationReceived', component_type=None, transport_node_id=None, timestamp=None, transport_node_name=None, sequence_no=None, timestamp_micro=None, component_name=None):  # noqa: E501
