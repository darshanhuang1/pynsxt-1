...
class StaticRouteNextHop(object):
    ...
    def administrative_distance(self, administrative_distance):
        ...
        :type: int
        """
        if administrative_distance is not None and administrative_distance > 255:  # noqa: E501
            raise ValueError("Invalid value for `administrative_distance`, must be a value less than or equal to `255`")  # noqa: E501
        if administrative_distance is not None and administrative_distance < 1:  # noqa: E501
            raise ValueError("Invalid value for `administrative_distance`, must be a value greater than or equal to `1`")  # noqa: E501
    ...
    def logical_router_port_id(self):
        ...
        Reference of logical router port to be used for next hop  # noqa: E501
