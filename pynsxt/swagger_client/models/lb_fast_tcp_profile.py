...
class LbFastTcpProfile(object):
    ...
    def __init__(self, close_timeout=8, idle_timeout=1800, ha_flow_mirroring_enabled=False):  # noqa: E501
    ...
    def close_timeout(self, close_timeout):
        ...
        :type: int
        """
        if close_timeout is not None and close_timeout > 60:  # noqa: E501
            raise ValueError("Invalid value for `close_timeout`, must be a value less than or equal to `60`")  # noqa: E501
        if close_timeout is not None and close_timeout < 1:  # noqa: E501
            raise ValueError("Invalid value for `close_timeout`, must be a value greater than or equal to `1`")  # noqa: E501
