...
class IpfixCollector(object):
    ...
    def collector_port(self, collector_port):
        ...
        :type: int
        """
        if collector_port is not None and collector_port > 65535:  # noqa: E501
            raise ValueError("Invalid value for `collector_port`, must be a value less than or equal to `65535`")  # noqa: E501
        if collector_port is not None and collector_port < 0:  # noqa: E501
            raise ValueError("Invalid value for `collector_port`, must be a value greater than or equal to `0`")  # noqa: E501
