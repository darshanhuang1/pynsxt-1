...
class LbHttpsMonitor(object):
    ...
    def __init__(self, response_status_codes=None, server_auth_crl_ids=None, server_auth='IGNORE', request_body=None, response_body=None, ciphers=None, client_certificate_id=None, request_method='GET', certificate_chain_depth=3, is_secure=None, request_url=None, server_auth_ca_ids=None, request_version='HTTP_VERSION_1_1', protocols=None):  # noqa: E501
