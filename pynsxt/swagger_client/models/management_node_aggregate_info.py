...
class ManagementNodeAggregateInfo(object):
    ...
    def __init__(self, node_interface_properties=None, node_status=None, node_interface_statistics=None, node_status_properties=None, transport_nodes_connected=None, role_config=None):  # noqa: E501
    ...
    def transport_nodes_connected(self, transport_nodes_connected):
        ...
        :type: int
        """
        if transport_nodes_connected is not None and transport_nodes_connected < 0:  # noqa: E501
            raise ValueError("Invalid value for `transport_nodes_connected`, must be a value greater than or equal to `0`")  # noqa: E501
