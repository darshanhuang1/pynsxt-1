...
class NodeProcessProperties(object):
    ...
    def __init__(self, _self=None, links=None, schema=None, mem_used=None, cpu_time=None, ppid=None, start_time=None, process_name=None, pid=None, uptime=None, mem_resident=None):  # noqa: E501
