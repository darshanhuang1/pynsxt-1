...
class VIPSubnet(object):
    ...
    def prefix_length(self, prefix_length):
        ...
        if prefix_length is not None and prefix_length > 31:  # noqa: E501
            raise ValueError("Invalid value for `prefix_length`, must be a value less than or equal to `31`")  # noqa: E501
        if prefix_length is not None and prefix_length < 1:  # noqa: E501
