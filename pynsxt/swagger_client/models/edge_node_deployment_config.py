...
from swagger_client.models.node_user_settings import NodeUserSettings  # noqa: F401,E501
...
class EdgeNodeDeploymentConfig(object):
    ...
    def node_user_settings(self):
        ...
        Username and password settings for the node. Note - these settings will be honored only during node deployment. Post deployment, CLI must be used for changing the user settings, changes to these parameters will not have any effect.   # noqa: E501
