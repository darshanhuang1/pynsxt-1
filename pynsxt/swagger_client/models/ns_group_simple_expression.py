...
class NSGroupSimpleExpression(object):
    ...
    def __init__(self, target_resource=None, target_property=None, target_type=None, value=None, op=None):  # noqa: E501
    ...
    def target_resource(self):
        ...
        Reference of the target. Will be populated when the property is a resource id, the op (operator) is EQUALS and populate_references is set to be true.   # noqa: E501
