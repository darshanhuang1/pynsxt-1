...
class ComputeManagerStatus(object):
    ...
    def __init__(self, version=None, connection_status=None, connection_errors=None, last_sync_time=None, connection_status_details=None, registration_errors=None, registration_status=None):  # noqa: E501
