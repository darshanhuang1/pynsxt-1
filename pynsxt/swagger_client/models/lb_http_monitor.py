...
class LbHttpMonitor(object):
    ...
    def __init__(self, response_status_codes=None, request_method='GET', request_body=None, response_body=None, request_url=None, request_version='HTTP_VERSION_1_1'):  # noqa: E501
