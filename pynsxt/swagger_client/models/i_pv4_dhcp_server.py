...
class IPv4DhcpServer(object):
    ...
    def __init__(self, dhcp_server_ip=None, options=None, dns_nameservers=None, domain_name=None, gateway_ip=None):  # noqa: E501
    ...
    def options(self):
        ...
        Defines the default options for all ip-pools and static-bindings of this server. These options will be ignored if options are defined for ip-pools or static-bindings.   # noqa: E501
