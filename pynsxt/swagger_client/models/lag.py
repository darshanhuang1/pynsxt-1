...
from swagger_client.models.uplink import Uplink  # noqa: F401,E501
...
class Lag(object):
    ...
    def number_of_uplinks(self, number_of_uplinks):
        ...
        if number_of_uplinks is not None and number_of_uplinks > 32:  # noqa: E501
            raise ValueError("Invalid value for `number_of_uplinks`, must be a value less than or equal to `32`")  # noqa: E501
        if number_of_uplinks is not None and number_of_uplinks < 2:  # noqa: E501
            raise ValueError("Invalid value for `number_of_uplinks`, must be a value greater than or equal to `2`")  # noqa: E501
