...
from swagger_client.models.nat_statistics_per_transport_node import NatStatisticsPerTransportNode  # noqa: F401,E501
...
class NatStatisticsPerLogicalRouter(object):
    ...
    def statistics_across_all_nodes(self):
        ...
        Rolled-up statistics for all rules on the logical router across all the nodes  # noqa: E501
