...
from swagger_client.models.pool_member import PoolMember  # noqa: F401,E501
from swagger_client.models.pool_member_group import PoolMemberGroup  # noqa: F401,E501
...
class LbPool(object):
    ...
    @property
    def _self(self):
        """Gets the _self of this LbPool.  # noqa: E501


        :return: The _self of this LbPool.  # noqa: E501
    ...
    def _self(self, _self):
        """Sets the _self of this LbPool.


        :param _self: The _self of this LbPool.  # noqa: E501
    ...
    @property
    def links(self):
        """Gets the links of this LbPool.  # noqa: E501

        The server will populate this field when returing the resource. Ignored on PUT and POST.  # noqa: E501

        :return: The links of this LbPool.  # noqa: E501
    ...
    def links(self, links):
        """Sets the links of this LbPool.

        The server will populate this field when returing the resource. Ignored on PUT and POST.  # noqa: E501

        :param links: The links of this LbPool.  # noqa: E501
    ...
    @property
    def schema(self):
        """Gets the schema of this LbPool.  # noqa: E501


        :return: The schema of this LbPool.  # noqa: E501
        :rtype: str
        """
        return self._schema
    ...
    def schema(self, schema):
        """Sets the schema of this LbPool.


        :param schema: The schema of this LbPool.  # noqa: E501
        :type: str
        """
    ...
    @property
    def revision(self):
        """Gets the revision of this LbPool.  # noqa: E501
        ...
        :return: The revision of this LbPool.  # noqa: E501
        :rtype: int
        """
    ...
    def revision(self, revision):
        """Sets the revision of this LbPool.

        The _revision property describes the current revision of the resource. To prevent clients from overwriting each other's changes, PUT operations must include the current _revision of the resource, which clients should obtain by issuing a GET operation. If the _revision provided in a PUT request is missing or stale, the operation will be rejected.  # noqa: E501

        :param revision: The revision of this LbPool.  # noqa: E501
        :type: int
        """
    ...
    def member_group(self):
        ...
        Load balancer pool support grouping object as dynamic pool members. When member group is defined, members setting should not be specified.   # noqa: E501
    ...
    def snat_translation(self):
        ...
        Depending on the topology, Source NAT (SNAT) may be required to ensure traffic from the server destined to the client is received by the load balancer. SNAT can be enabled per pool. If SNAT is not enabled for a pool, then load balancer uses the client IP and port (spoofing) while establishing connections to the servers. This is referred to as no-SNAT or TRANSPARENT mode.   # noqa: E501
    ...
    def algorithm(self, algorithm):
        ...
        :type: str
        """
        allowed_values = ["ROUND_ROBIN", "WEIGHTED_ROUND_ROBIN", "LEAST_CONNECTION", "IP_HASH"]  # noqa: E501
    ...
    def tcp_multiplexing_number(self, tcp_multiplexing_number):
        ...
        :type: int
        """
        if tcp_multiplexing_number is not None and tcp_multiplexing_number < 0:  # noqa: E501
            raise ValueError("Invalid value for `tcp_multiplexing_number`, must be a value greater than or equal to `0`")  # noqa: E501
    ...
    def min_active_members(self, min_active_members):
        ...
        :type: int
        """
        if min_active_members is not None and min_active_members < 1:  # noqa: E501
            raise ValueError("Invalid value for `min_active_members`, must be a value greater than or equal to `1`")  # noqa: E501
