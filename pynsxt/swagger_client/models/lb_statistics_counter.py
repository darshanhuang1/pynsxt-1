...
class LbStatisticsCounter(object):
    ...
    def __init__(self, source_ip_persistence_entry_size=None, packets_out=None, bytes_out_rate=None, total_sessions=None, http_request_rate=None, bytes_out=None, packets_in_rate=None, bytes_in_rate=None, current_sessions=None, max_sessions=None, packets_out_rate=None, bytes_in=None, current_session_rate=None, packets_in=None):  # noqa: E501
