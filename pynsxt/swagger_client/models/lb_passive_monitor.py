...
class LbPassiveMonitor(object):
    ...
    def __init__(self, max_fails=5, timeout=5):  # noqa: E501
    ...
    def max_fails(self, max_fails):
        ...
        :type: int
        """
        if max_fails is not None and max_fails < 1:  # noqa: E501
            raise ValueError("Invalid value for `max_fails`, must be a value greater than or equal to `1`")  # noqa: E501
